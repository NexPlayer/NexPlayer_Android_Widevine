...
Please refer to the [NexPlayer for Android](https://github.com/NexPlayerSDK/NexPlayer_Android) documentation if you need assistance integrating NexPlayer on Android.
